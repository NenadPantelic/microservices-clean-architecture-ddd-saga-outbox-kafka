insert into "order".order(id, customer_id, restaurant_id, tracking_id, price, order_status, failure_messages)
...
insert into "order".order_item(id, order_id, product_id, price, quantity, sub_total)
