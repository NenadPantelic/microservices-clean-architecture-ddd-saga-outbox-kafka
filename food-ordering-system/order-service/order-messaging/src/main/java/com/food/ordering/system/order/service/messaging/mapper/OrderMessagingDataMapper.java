...
public class OrderMessagingDataMapper {
    ...
    public RestaurantApprovalResponse approvalResponseAvroModelToApproveResponse(RestaurantApprovalResponseAvroModel restaurantApprovalResponseAvroModel) {
        ...
        return RestaurantApprovalRequestAvroModel.newBuilder()
                ...
                .setProducts(orderApprovalEventPayload.getProducts().stream().map(orderApprovalEventProduct ->
                        com.food.ordering.system.kafka.order.avro.model.Product.newBuilder()
                                .setId(orderApprovalEventProduct.id())
                                .setQuantity(orderApprovalEventProduct.quantity())
